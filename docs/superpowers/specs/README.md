...
| [python/](python/overview.md) | **Phases 1–6 complete, Phase 7 not started** — [question-taxonomy.md](python/question-taxonomy.md) (43 concept groups, incl. this track's own Phase-2 gap-hunt: 8 additions) → [roadmap.md](python/roadmap.md) → 43 planned pages, awaiting page-writing. Unique to this track: "predict the output" is a sixth question-variant type. `python/roadmap.html` and the root tile's badge are already wired per the Phase-1 mandate. |
