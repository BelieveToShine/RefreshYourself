...
| [dotnet/](dotnet/overview.md) | **All 7 phases complete — 25/25 pages written** (23 original + 2 added 2026-09-18 for a user-reported Unit Testing gap). [question-taxonomy.md](dotnet/question-taxonomy.md) → [roadmap.md](dotnet/roadmap.md) → 25 tiered/prioritized pages, live on the site and on [`dotnet/roadmap.html`](../../../dotnet/roadmap.html). MVC lives as a grouped subsection, not a separate track — rescoped from the old, never-written ".NET Framework" slot. |
...
| [ai/](ai/overview.md) | **All 7 phases complete — 48/48 pages written.** [question-taxonomy.md](ai/question-taxonomy.md) (48 concept groups, incl. this track's own Phase-2 gap-hunt: 3 additions folded into existing pages) → [roadmap.md](ai/roadmap.md) → 48 tiered/prioritized pages, live on the site and on [`ai/roadmap.html`](../../../ai/roadmap.html). Not part of the ordered core-backend path — grouped with React/Angular/DSA/Python under "🗂️ Other tracks." |
...
| [python/](python/overview.md) | **All 7 phases complete — 43/43 pages written.** [question-taxonomy.md](python/question-taxonomy.md) (43 concept groups, incl. this track's own Phase-2 gap-hunt: 8 additions) → [roadmap.md](python/roadmap.md) → 43 tiered/prioritized pages, live on the site and on [`python/roadmap.html`](../../../python/roadmap.html), grouped by 11 cross-tier concept clusters rather than by tier. Unique to this track: "predict the output" is a sixth question-variant type, rendered as a real code block + "what does this print/do, and why?" on every `[predict]`-tagged page. Not part of the ordered core-backend path — grouped with React/Angular/DSA/AI. |
| [dsa/](dsa/overview.md) | **All 7 phases complete — 30/30 pages written.** [question-taxonomy.md](dsa/question-taxonomy.md) (30 concept groups: this session's own 19-group draft, expanded to 30 by the user's own vendor-cross-checked review, plus this track's own Phase-2 gap-hunt: 2 additions folded into an existing page) → [roadmap.md](dsa/roadmap.md) → 30 tiered/prioritized pages, live on the site and on [`dsa/roadmap.html`](../../../dsa/roadmap.html). Deliberately organized around reusable interview patterns/trade-offs rather than an algorithm encyclopedia — see the taxonomy's own "Considered and excluded" list. Not part of the ordered core-backend path — grouped with React/Angular/Python/AI under "🗂️ Other tracks." |
| [javascript/](javascript/overview.md) | **All 7 phases complete — 38/38 pages written.** [question-taxonomy.md](javascript/question-taxonomy.md) (37 groups the user personally vendor-checked and shared directly, plus this track's own Phase-2 gap-hunt: 1 addition, Testing Fundamentals) → [roadmap.md](javascript/roadmap.md) → 38 tiered/prioritized pages, live on the site and on [`javascript/roadmap.html`](../../../javascript/roadmap.html). Built while a second concurrent session was independently building the same track on the shared machine — every resulting duplicate/overlap was reconciled, see the overview's own Status section. Sits in the "🎨 Frontend" homepage section alongside HTML & CSS, React, and Angular. |
| [htmlcss/](htmlcss/overview.md) | **All 7 phases complete — 34/34 pages written.** [question-taxonomy.md](htmlcss/question-taxonomy.md) (32 groups the user shared directly, plus this track's own Phase-2 gap-hunt: 2 additions, Colors/Backgrounds/Gradients and Accessibility in Practice) → [roadmap.md](htmlcss/roadmap.md) → 34 tiered/prioritized pages, live on the site and on [`htmlcss/roadmap.html`](../../../htmlcss/roadmap.html), grouped by 5 cross-tier concept clusters (the user's own HTML/CSS Fundamentals/Layout/Styling & UI/Advanced-Production buckets, reused directly) rather than by tier. Governing content rule: every page connects back to "what does the browser actually do" (HTML→DOM, CSS→CSSOM, →Render Tree→Layout→Paint→Composite) rather than reading as a tag/property list — `advanced/1.html` (Browser Rendering) owns the full picture. Sits in the "🎨 Frontend" homepage section alongside JavaScript, React, and Angular. |
